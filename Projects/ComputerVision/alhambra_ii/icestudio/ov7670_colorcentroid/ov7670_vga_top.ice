  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "e58e65e5-9166-4dee-b9bf-ea22c329e7eb",
        ...
        {
          "id": "5f560f73-3597-4331-98f1-2e96913e1c05",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "e58e65e5-9166-4dee-b9bf-ea22c329e7eb",
        ...
        {
          "source": {
            "block": "5f560f73-3597-4331-98f1-2e96913e1c05",
            "port": "19c8f68d-5022-487f-9ab0-f0a3cd58bead"
          },
          "target": {
            "block": "94304c33-b298-47c9-83ba-49c8c44636fc",
        ...
        },
        {
          "source": {
            "block": "6c34015f-b145-4bcd-a6af-170eee5e79ca",
            "port": "35501b90-0acc-4cbc-a1ef-77eb2c12642b"
          },
          "target": {
            "block": "94304c33-b298-47c9-83ba-49c8c44636fc",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "f3ef6eb6-a910-4cfe-b9ef-3d881707fd7a",
              "type": "basic.input",
              "data": {
                "name": "centroid",
                "range": "[7:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "f3ef6eb6-a910-4cfe-b9ef-3d881707fd7a",
                "port": "out"
              },
              "target": {
                "block": "82b8ebcd-84e4-4399-8622-144e382dd5bb",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "3913e7bb-3d08-4ddf-aa6e-0fa91691fb55",
              "type": "basic.input",
              "data": {
                "name": "centroid",
                "range": "[7:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "3913e7bb-3d08-4ddf-aa6e-0fa91691fb55",
                "port": "out"
              },
              "target": {
                "block": "238f5dfb-5373-4e94-8a9d-82da055fa809",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "35501b90-0acc-4cbc-a1ef-77eb2c12642b",
              "type": "basic.output",
              "data": {
                "name": "rgbfilter",
                "range": "[2:0]",
            ...
            {
              "id": "d2aaf96a-627a-46e5-a45c-4f247247f53f",
              "type": "basic.output",
              "data": {
                "name": "centroid",
                "range": "[7:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "d2aaf96a-627a-46e5-a45c-4f247247f53f",
                "port": "in"
              },
              "size": 8
            },
