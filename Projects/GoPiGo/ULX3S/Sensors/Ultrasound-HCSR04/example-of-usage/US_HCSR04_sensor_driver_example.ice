{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "c3347ef0-cbd2-466f-a8dd-91f00ee10db2",
          "type": "basic.output",
          "data": {
            "name": "LEDS",
            "range": "[7:0]",
        ...
        {
          "id": "0e59f8ef-2a06-46f1-80d4-1c14a8db0fba",
          "type": "basic.input",
          "data": {
            "name": "US_ECHO",
            "pins": [
        ...
        {
          "id": "f05354fe-05c8-4442-b15e-71acd8afeabc",
          "type": "basic.output",
          "data": {
            "name": "US_TRIGGER",
            "pins": [
        ...
        {
          "id": "e2018b74-afd5-4bfe-a65c-2b638e505274",
          "type": "basic.constant",
          "data": {
            "name": "Period",
            "value": "1000",
        ...
        {
          "id": "4ecc0a39-82d6-43c1-b6d4-129762a89647",
          "type": "84df5f4d8296ea48f4017b9f3a58a191577873e4",
          "position": {
            "x": 376,
            "y": 240
          },
        ...
        {
          "id": "6cfd0b2c-c406-41cc-86b7-d977fd00c843",
          "type": "basic.info",
          "data": {
            "info": "US Sensor Driver",
            "readonly": false
          },
          "position": {
            "x": 344,
      ...
      "wires": [
        {
          "source": {
            "block": "e2018b74-afd5-4bfe-a65c-2b638e505274",
            "port": "constant-out"
          },
          "target": {
            "block": "4ecc0a39-82d6-43c1-b6d4-129762a89647",
            "port": "5e093b29-dda0-440f-af23-681ddf23acfe"
          }
        },
        {
          "source": {
            "block": "0e59f8ef-2a06-46f1-80d4-1c14a8db0fba",
            "port": "out"
          },
          "target": {
            "block": "4ecc0a39-82d6-43c1-b6d4-129762a89647",
            "port": "1923463f-219e-4755-8495-1ef46667198f"
          }
        },
        {
          "source": {
            "block": "4ecc0a39-82d6-43c1-b6d4-129762a89647",
            "port": "025f0df1-3d63-4565-a164-1a33c06487d0"
          },
          "target": {
            "block": "f05354fe-05c8-4442-b15e-71acd8afeabc",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "4ecc0a39-82d6-43c1-b6d4-129762a89647",
            "port": "8eaa1100-1fb5-47ab-923c-06978b232d43"
          },
          "target": {
            "block": "c3347ef0-cbd2-466f-a8dd-91f00ee10db2",
            "port": "in"
          },
          "vertices": [
            {
  ...
  "dependencies": {
    "84df5f4d8296ea48f4017b9f3a58a191577873e4": {
      "package": {
        "name": "US Sensor Drv HCSR04",
        "version": "",
        "description": "",
        "author": "",
        "image": ""
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "8eaa1100-1fb5-47ab-923c-06978b232d43",
              "type": "basic.output",
              "data": {
                "name": "distance_cms",
                "range": "[7:0]",
            ...
            {
              "id": "025f0df1-3d63-4565-a164-1a33c06487d0",
              "type": "basic.output",
              "data": {
                "name": "Trigger"
              },
            ...
            {
              "id": "1923463f-219e-4755-8495-1ef46667198f",
              "type": "basic.input",
              "data": {
                "name": "Echo",
                "clock": false
            ...
            {
              "id": "5e093b29-dda0-440f-af23-681ddf23acfe",
              "type": "basic.constant",
              "data": {
                "name": "T_msec",
                "value": "100",
            ...
            {
              "id": "f9d54fcd-0781-4b1e-9a85-19b85451ba7a",
              "type": "70b92d8ebdc990bbdb8af2d34cbb46bb56583449",
              "position": {
                "x": -1968,
                "y": -136
              },
            ...
            {
              "id": "5af8f0c9-53c6-4b22-a69d-463140fbc31c",
            ...
            {
              "id": "a0b5bc8f-a3ca-4a46-aeb7-12dc750f2f89",
              "type": "basic.code",
              "data": {
                "code": "assign o = i[13:6];",
                "params": [],
                "ports": {
                  "in": [
                    {
            ...
            {
              "id": "8cece600-199b-4f63-b18d-623f1fee0cd2",
              "type": "basic.info",
              "data": {
                "info": "This input shall be connected \nto the ECHO output of the sensor",
                "readonly": false
              },
              "position": {
                "x": -2160,
            ...
            {
              "id": "390c3346-ef92-4f0e-ad9f-9fc03dc6830c",
              "type": "basic.info",
              "data": {
                "info": "This output shall be connected \nto the TRIGGER input of the sensor",
                "readonly": false
              },
              "position": {
                "x": -1880,
            ...
            {
              "id": "38541c50-3547-4a9e-ab0e-f2d223927b1a",
              "type": "basic.info",
              "data": {
                "info": "Discard 6 LSBs, \nthis will convert from \nmicrosecs to cms (approx.) ",
                "readonly": false
              },
              "position": {
                "x": -1248,
          ...
          "wires": [
            {
              "source": {
                "block": "5e093b29-dda0-440f-af23-681ddf23acfe",
                "port": "constant-out"
              },
              "target": {
                "block": "f9d54fcd-0781-4b1e-9a85-19b85451ba7a",
                "port": "7def06f6-e263-45bd-b2a8-c9fac24e756e"
              }
            },
            {
              "source": {
                "block": "1923463f-219e-4755-8495-1ef46667198f",
                "port": "out"
              },
              "target": {
                "block": "f9d54fcd-0781-4b1e-9a85-19b85451ba7a",
            ...
            },
            {
              ...
              "target": {
                "block": "025f0df1-3d63-4565-a164-1a33c06487d0",
                "port": "in"
              }
            },
            {
              ...
              "target": {
                "block": "5af8f0c9-53c6-4b22-a69d-463140fbc31c",
            ...
            },
            {
              ...
              "target": {
                "block": "a0b5bc8f-a3ca-4a46-aeb7-12dc750f2f89",
                "port": "i"
              },
              "size": 16
            },
            {
              ...
              "target": {
                "block": "8eaa1100-1fb5-47ab-923c-06978b232d43",
                "port": "in"
              },
              "size": 8
            }
    ...
    "70b92d8ebdc990bbdb8af2d34cbb46bb56583449": {
      "package": {
        "name": "Sensor_Ultrasonidos_HCSR04",
        "version": "1.0",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "7def06f6-e263-45bd-b2a8-c9fac24e756e",
              "type": "basic.constant",
              "data": {
                "name": "T_msec",
                "value": "1000",
            ...
            },
            {
              ...
              "type": "basic.info",
              "data": {
                "info": "Activamos el sensor cada T_msec milisegundos, enviando un pulso de 10 microseg por la patilla TRIGGER.\n\nPor defecto , cada  1 segundo",
                "readonly": true
              },
              "position": {
                "x": -1720,
            ...
            {
              "id": "149d49ee-b62b-4bb0-9be7-ccfa164dda19",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "149d49ee-b62b-4bb0-9be7-ccfa164dda19",
                "port": "c138a610-b61f-4e7c-bb8a-c4f3b0b9f95c"
              },
              "target": {
                "block": "1dafc7e2-693c-4bde-85cf-f804358fa0e3",
            ...
            {
              "source": {
                "block": "7def06f6-e263-45bd-b2a8-c9fac24e756e",
                "port": "constant-out"
              },
              "target": {
                "block": "149d49ee-b62b-4bb0-9be7-ccfa164dda19",
