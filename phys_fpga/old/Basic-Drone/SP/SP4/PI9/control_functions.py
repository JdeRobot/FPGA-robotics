...
TrimmValues = [ 0, 128, 128, 128 ,0]	# Kp_altura, Offsets: Derecha/Izquierda, Delante/Detras, GiroIzquierda/Derecha, Ki_altura



# Setting up trimming values
def setPIDValues(alt_kp,alt_ki,OffDerIzq,OffDelDet,OffGiroDI):
