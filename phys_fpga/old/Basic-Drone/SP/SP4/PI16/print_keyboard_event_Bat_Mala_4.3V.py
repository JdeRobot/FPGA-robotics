...
control_functions.setcontrols(25, 	128, 	128, 	128, 	4)
# ------------ ETAPA 2 ------------ #
# Set Trim & PID Parameters	   Alt_Kp	Alt_Ki	Alt_Kd	XY_Kp	XY_Ki	XY_Kd 	Giro
...
flight_Derecha = 128;
# Set Flight Parameters		  AA 	DI				DD 				GID 	Order Duration
control_functions.setcontrols(25, 	flight_Derecha, flight_Delante, 128, 	2)
flight_Derecha = 160;
control_functions.setcontrols(25, 	flight_Derecha, flight_Delante, 128, 	2)
flight_Delante = 128;
control_functions.setcontrols(25, 	flight_Derecha, flight_Delante, 128, 	2)
...
control_functions.setcontrols(20, 	flight_Derecha, flight_Delante, 128, 	0.3)
# Set Trim & PID Parameters	   Alt_Kp	Alt_Ki	Alt_Kd	XY_Kp	XY_Ki	XY_Kd 	Giro
